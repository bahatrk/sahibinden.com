...
INSERT INTO emlak_ilanlari (
  id, kategori, satisTuru, emlakTipi, baslik, aciklama, fiyat, konum, image,
  metreKareBrut, metreKareNet, odaSayisi, binaYasi,
  bulunduguKat, katSayisi, isitma, asansor, kimden, takas
)
VALUES (
  1, 'Konut', 'Satılık', 'Villa', '3+1 Daire', 'Merkezi konumda, geniş daire', 
...
VALUES (
  2, 'Konut', 'Kiralık', 'Daire', '2+1 Daire', 'Yeni tadilatlı',
...
VALUES (
  3, 'Bina', 'Satılık', NULL, 'Ofis Binası', 'Şehir merkezinde',
