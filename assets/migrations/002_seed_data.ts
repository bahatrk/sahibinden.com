...
VALUES (1, 'Vasıta', 'SUV', 'Toyota', 'Toyota RAV4', 'Temiz araç', 350000, 'İstanbul', 'https://images.unsplash.com/photo-1706509234538-9831b1b33d66?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
ON CONFLICT(id) DO UPDATE SET
  kategori = excluded.kategori,
...
INSERT INTO araba_ilanlari (id, kategori, altKategori, marka, model, baslik, aciklama, fiyat, konum, image)
VALUES (2, 'Vasıta', 'Otomobil', 'Honda', 'Honda Civic', 'Bakımlı', 250000, 'Ankara', 'https://images.unsplash.com/photo-1610768207795-72169abdf0d4?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
ON CONFLICT(id) DO UPDATE SET
  kategori = excluded.kategori,
  altKategori = excluded.altKategori,
  marka = excluded.marka,
